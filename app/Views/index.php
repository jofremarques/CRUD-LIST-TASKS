    ...
    <div class="main">
        <div class="nav">
            <div class="menu">
                ...
                <ul>
                    <li> <i class="fa fa-home"></i>Tarefas
                        <ul>
                            <li>Finalizado</li>
                            <li>Cancelado</li>
                            <li>Andamento</li>
            ...
            <div class="viewHeader">
                <div class="row flex justify-between">
                    ...
                    <div class="content-button">
                        <button class="btn-add" data-button-modal='add-modal'>Adicionar</button>
                    </div>
                </div>
            </div>
            <div class="content">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <button class="btn-edit" data-button-modal='edit-modal'>
                                ...
                                <td>
                                    <button class="btn-remove" data-button-modal='delete-modal'>

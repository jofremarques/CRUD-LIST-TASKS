<div id="details-modal" class="modal">
    <div class="content-modal">
        <div class="head-modal flex">
            ...
            <span class="head-modal-fechar close-modal" onclick="closeModal('details-modal')">X</span>
        </div>
        ...
        <div class="footer-modal">
            ...
            <button class="close-modal" onclick="closeModal('details-modal')">Fechar</button>
        </div>
    </div>
</div>